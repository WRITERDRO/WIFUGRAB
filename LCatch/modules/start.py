...
async def generate_start_message(client, message):
    ...
    caption = """🍃 ʜᴇʏ ᴛʜᴇʀᴇ, ɪ'ᴍ ˹ᴡᴀɪғᴜ - ʜᴜsʙᴀɴᴅᴏs ɢꝛᴀʙʙᴇꝛ ʙᴏᴛ˼ 🫧
━✦✧━✦✧━✦✧━

◈ ᴍʏ ᴘᴜʀᴘᴏsᴇ:
  ɪ sᴘᴀᴡɴ ᴡᴀɪғᴜs & ʜᴜsʙᴀɴᴅᴏs ɪɴ ʏᴏᴜʀ ᴄʜᴀᴛ ғᴏʀ ᴜsᴇʀs ᴛᴏ ɢʀᴀʙ.

◈ ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴍᴇ:
  ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ & ᴛᴀᴘ ᴛʜᴇ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ғᴏʀ ᴍᴏʀᴇ.

━✦✧━✦✧━✦✧━
✨ ʟᴇᴛ’s ʜᴀᴠᴇ ғᴜɴ ɢʀᴀʙʙɪɴɢ!"""

    buttons = [
        [InlineKeyboardButton("Aᴅᴅ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ", url=f"https://t.me/Veronwaifubot?startgroup=true")],
